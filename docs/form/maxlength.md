...
输入长度组件扩展自控件[`bootstrap-maxlength`](https://github.com/mimo84/bootstrap-maxlength/)。

![](./img/jx-maxlength/49cfc2a6.png)

## 使用方法

使用`maxlength`指定允许的最大长度
```html
...
```js
$('[name=name]').on('autosize:resized', function() {
