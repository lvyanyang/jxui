...
jx.ui.Tree = function ($element, options) {
    ...
    return {
        ...
        collapseAll: function (target) {
            $element.tree('collapseAll', target);
        },
        ...
        cancelEdit: function (target) {
            $element.tree('cancelEdit', target);
        },
...
jx.plugin({
    ...
    instance: function ($ele, ops) {
        return jx.ui.Tree($ele, ops);
    },
    options: function ($ele) {
        return jx.parseOptions($ele, ['url', 'method', 'loadEmptyMessage', 'filterEmptyMessage', 'maskMsg', {
            animate: 'boolean',
            checkbox: 'boolean',
